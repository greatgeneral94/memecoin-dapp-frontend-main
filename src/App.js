...
import image from '../src/5JfHKHU.png';
...
function App() {
  ...
  const contractAddress = '0x57ceA5C5B5EcfFe5fc8e02dDc3ea5D9F9d66462E';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        ...
        <img className="inline p-3 ml-2" src={image} alt="Meme Coin" width="60" height="30" />
      </h2>
